            ...
            <div class="relative bg-white rounded-lg shadow-sm">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <div class="inline-flex gap-6 w-full items-center justify-center">
                        <form action="{{ route('dashboard.pelanggan.delete', $data_pelanggan->id_pelanggan) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                            <button data-modal-hide="popup-modal-delete-{{ $data_pelanggan->id_pelanggan }}"
                                type="submit"
                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                Ya, Hapus
                            </button>
                        </form>
                        <button data-modal-hide="popup-modal-delete-{{ $data_pelanggan->id_pelanggan }}" type="button"
